...
@implementation Style9CustomCell

@synthesize songLabel,songIdLabel,cpLabel,dataDictionary,img,priceLabel;
...
- (id)initWithFrame:(CGRect)frame reuseIdentifier:(NSString *)reuseIdentifier {
    if (self = [super initWithFrame:frame reuseIdentifier:reuseIdentifier]) {
        // Initialization code
		self = [[[[NSBundle mainBundle] loadNibNamed:@"Style9CustomCell" owner:self options:nil] objectAtIndex:0] retain];
    }
    return self;
}
