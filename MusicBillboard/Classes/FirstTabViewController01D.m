...
@implementation FirstTabViewController01D

@synthesize songsTableView,appDelegate,picView,contentLabel,musicBoxDictionary,mySectionRow,avController,xmlData;
...
-(void)initDataSource{	
	...
	//NSString *songsUrl=[musicBoxDictionary objectForKey:ContentListUrl];
...
-(void)initMusicBoxInfo{
	contentLabel.text=[musicBoxDictionary objectForKey:SecondaryLabel];
	
	//UIImage *img=[UIImage imageNamed:@"question.png"];
	
	//picView.image=img;
	
	NSString *imgpath=[musicBoxDictionary objectForKey:ImageView];
	...
	picView.frame = CGRectMake(32, 10, 60, 60);
}
